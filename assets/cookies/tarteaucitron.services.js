...
tarteaucitron.services.plezi = {
    ...
    js: function () {
        ...
        tarteaucitron.addScript(
            "https://app.plezi.co/scripts/ossleads_analytics.js?tenant=" + tarteaucitron.user.pleziTenant + "&tw=" + tarteaucitron.user.pleziTw
        );
    }
};
...
tarteaucitron.services.crazyegg = {
    ...
    js: function () {
        ...
        tarteaucitron.addScript(
            "//script.crazyegg.com/pages/scripts/" + tarteaucitron.user.crazyeggId.substr(0, 4) + "/" + tarteaucitron.user.crazyeggId.substr(4, 4) + ".js"
        );
    }
};
...
tarteaucitron.services.adsenseauto = {
    ...
    js: function () {
        ...
        tarteaucitron.addScript(
            "https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=" + tarteaucitron.user.adsensecapub,
            "",
            "",
            "",
            "crossorigin",
...
tarteaucitron.services.googlefonts = {
    ...
    js: function () {
        ...
        tarteaucitron.addScript("https://ajax.googleapis.com/ajax/libs/webfont/1.6.26/webfont.js", "", function () {
            WebFont.load({
                google: {
...
tarteaucitron.services.maps_noapi = {
    ...
    js: function () {
        ...
        tarteaucitron.fallback(["googlemaps_embed"], function (x) {
            ...
            return (
                '<iframe width="' + width + '" height="' + height + '" src="' + widgetURL + '" style="border:0;" allowfullscreen="" loading="lazy"></iframe>'
            );
        });
    },
    fallback: function () {
