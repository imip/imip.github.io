...
var tarteaucitron = {
        ...
        purge: function (arr) {
            ...
            for (i = 0; i < arr.length; i += 1) {
                ...
                if (document.cookie.match(rgxpCookie)) {
                    ...
                    document.cookie =
                        arr[i] + "=; expires=Thu, 01 Jan 2000 00:00:00 GMT; path=/; domain=." + location.hostname.split(".").slice(-2).join(".") + ";";
                }
            }
        },
    ...
    getLanguage: function () {
        ...
        var lang = navigator.language || navigator.browserLanguage || navigator.systemLanguage || navigator.userLang || null,
            userLanguage = "fr"; //lang ? lang.substr(0, 2) : null;
    ...
    checkIfExist: function (elemId) {
        "use strict";
        return (
            document.getElementById(elemId) !== null && document.getElementById(elemId).offsetWidth !== 0 && document.getElementById(elemId).offsetHeight !== 0
        );
    },
    makeAsync: {
        antiGhost: 0,
